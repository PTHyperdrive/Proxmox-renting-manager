"""
Proxmox VM Time Tracking Service - Main Application

FastAPI application that tracks VM running time from Proxmox logs.
"""
...
from .routes import vms_router, sessions_router, rentals_router
...
async def lifespan(app: FastAPI):
    ...
    # Startup
    logger.info("Starting Proxmox VM Time Tracking Service...")
    await init_db()
...
app = FastAPI(
    title="Proxmox VM Time Tracking",
    description="""
    Track and manage VM running time from Proxmox logs.
    
    Features:
    - Sync VM start/stop events from Proxmox
